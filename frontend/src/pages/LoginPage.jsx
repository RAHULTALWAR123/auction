...
const LoginPage = () => {
  ...
  return (
    ...
    <motion.div
      className='mt-8 sm:mx-auto sm:w-3/4 sm:max-w-md'
      initial={{ opacity: 0, y: 20 }}
      animate={{ opacity: 1, y: 0 }}
            ...
            <div className='mt-1 relative rounded-md shadow-sm'>
              ...
              <input
                ...
                rounded-md shadow-sm
                 placeholder-gray-400 focus:outline-none focus:ring-indigo-600 
          ...
          <div>
            ...
            <div className='mt-1 relative rounded-md shadow-sm'>
              ...
              <input
                ...
                className=' block w-full px-3 py-2 pl-10 bg-gray-900 border border-gray-600 
                rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-600 focus:border-indigo-600 sm:text-sm'
                placeholder='••••••••'
              />
            </div>
          </div>
